...
class HomePageView extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildRecentlyVisitedSection(homeController),
            const SizedBox(height: 20),
            _buildCategoryGrid(context, homeController),
          ],
        ),
      ),
    );
  ...
  Widget _buildRecentlyVisitedSection(HomePageController controller) {
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height: 210,
          child: Obx(
                () => controller.recentlyVisitedBooks.isEmpty
                ? const Center(child: Text('No recently visited books.', style: TextStyle(color: Colors.grey, fontFamily: 'rubik')))
                : ListView.builder(
              scrollDirection: Axis.horizontal,
              itemCount: controller.recentlyVisitedBooks.length,
              itemBuilder: (context, index) {
                final book = controller.recentlyVisitedBooks[index];
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(book.title, textAlign: TextAlign.start, maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontWeight: FontWeight.w500,
              fontSize: 12.5, color: Colors.blueGrey[800] ,fontFamily: 'rubik')),
            ),
          ],
        ),
      ),
  ...
  Widget _buildCategoryGrid(BuildContext context, HomePageController controller) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Padding(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                Get.to(() => CategoryPageView(category: category));
              },
              child: Card(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(child: Center(child: Align(alignment: Alignment.centerLeft,child: Text(category, style: TextStyle(fontWeight: FontWeight.w500,fontFamily: 'rubik',color: Colors.blueGrey[800], fontSize: 13,))))),
                  ],
                ),
              ),
            );
